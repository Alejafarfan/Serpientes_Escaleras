 ...
 * @author farfa
 */
public class Es_15x15 extends javax.swing.JFrame {
     ...
     */
    public Es_15x15(String players) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Es_15x15.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
